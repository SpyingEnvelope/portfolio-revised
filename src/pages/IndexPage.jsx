/* This is the home page. It will render a simple
banner to display on the screen with an image of myself and a short introduction
of who I am*/
...
function IndexPage() {
  return (
    ...
    <div className="z-20 relative">
      <h2 className="text-xl md:text-3xl lg:text-4xl">This is the index page</h2>
      <p>
